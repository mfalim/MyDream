...
Route::name('mydream.')->group(function () {
    // Halaman 1 — Landing page
    Route::get('/', [HomeController::class, 'index'])->name('home');

    // Halaman 2 — Store (daftar card paket & vendor)
...
| User Routes
|--------------------------------------------------------------------------
| NOTE: semua data di bawah ini masih DUMMY untuk keperluan testing UI.
| Nanti tinggal diganti sumbernya dari database / relasi Eloquent asli.
*/
...
Route::prefix('user')
    ...
    ->group(function () {
        ...
        /*
        |----------------------------------------------------------------
        | Data vendor rekanan (dipakai bersama oleh explore, overview,
        | payment & vendor-confirmation)
        |----------------------------------------------------------------
        */
        $vendors = [
...
Route::prefix('user')
    ...
    ->group(function () {
        ...
        Route::get('/explore-vendor', function () {
            return view('user.explore.index');
        })->name('explore-vendor');

        // Data vendor dipakai bersama oleh halaman overview & pembayaran.
        // TODO: pindahkan ke model/DB kalau datanya sudah dinamis.
        $vendors = [
            ...
            'dwiki-jazz-quintet' => [
                ...
                'price' => 'Rp 22.000.000',
                'image' => 'https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=1400&q=85',
                'description' => 'Hiburan musik live dengan nuansa jazz elegan, string quartet dan custom songlist.',
                'location' => 'Jakarta',
                'capacity' => 'Full Event',
                'experience' => '68+ Acara',
                'service' => 'Live Entertainment',
            ...
            'puspa-gelato-coffee' => [
                ...
                'price' => 'Rp 12.500.000',
                'image' => 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?auto=format&fit=crop&w=1400&q=85',
                'description' => 'Luxury dessert stall dengan gelato autentik Italia dan layanan coffee station untuk acara pernikahan.',
                'location' => 'Jakarta',
                'capacity' => '400 Porsi',
                'experience' => '62+ Acara',
                'service' => 'Dessert & Coffee',
            ...
            'luminaire-pyrotechnics' => [
                ...
                'price' => 'Rp 9.500.000',
                'image' => 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&w=1400&q=85',
                'description' => 'Special effect untuk momen Hari H dengan cold firework fountain yang aman digunakan di venue indoor.',
                'location' => 'Jakarta',
                'capacity' => 'Indoor Safe',
                'experience' => '49+ Acara',
                'service' => 'Special Effects',
        ...
        /*
        |----------------------------------------------------------------
        | 4. VENDOR OVERVIEW (detail 1 vendor)
        |----------------------------------------------------------------
        */
        Route::get('/explore-vendor/{vendor}', function ($vendor) use ($vendors) {
        ...
        */
        Route::get('/explore-vendor/{vendor}/payment', function ($vendor) use ($vendors) {
            ...
            $dp = (int) round($priceNumeric * 0.3);
            $lunas = (int) round($priceNumeric * 0.97);
            $savings = $priceNumeric - $lunas;
            $cicilan = (int) round($priceNumeric / 6);
