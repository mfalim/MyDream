...
<main class="wo-page rundown-calendar">
    ...
    <div class="rc-head">
        ...
        <a href="{{ route('user.rundown.create') }}" class="wo-btn wo-btn-dark">
        ...
        <div class="wo-card rc-calendar-card">
            ...
            <div class="rc-cal-top">
                <div style="display: flex; gap: 12px; align-items: center;">
                    <button type="button" class="wo-btn wo-btn-outline" onclick="changeMonth(-1)">
                ...
                <span class="wo-badge wo-badge-neutral">{{ $tabCounts['all'] }} Acara</span>
            </div>
...
function changeMonth(direction) {
    ...
    const currentYear = parseInt(url.searchParams.get('year') || {{ date('Y') }});
    const currentMonth = parseInt(url.searchParams.get('month') || {{ date('m') }});
